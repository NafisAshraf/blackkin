...
export default function EditProductPage() {
  ...
  const slugAvailable = useQuery(
    ...
    debouncedSlug.trim()
      ? { slug: debouncedSlug, excludeId: productId }
      : "skip",
  );
  ...
  useEffect(() => {
    ...
    if ((product as any).saleDisplayMode)
      setSaleDisplayMode((product as any).saleDisplayMode);
    setSaleStartMode(product.saleStartMode);
    if (product.saleStartTime)
      setSaleStartTime(toDatetimeLocal(product.saleStartTime));
    setSaleEndMode(product.saleEndMode);
    if (product.saleEndTime)
      setSaleEndTime(toDatetimeLocal(product.saleEndTime));
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 items-start">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              {status === "scheduled" && (
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Product becomes visible to customers at this time
                    automatically.
                  </p>
                </div>
              )}
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <RadioGroupItem
                            value="custom"
                            id="edit-start-custom"
                          />
                          <Label
                            htmlFor="edit-start-custom"
                            className="cursor-pointer font-normal"
                          >
                            Custom date & time
                          </Label>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-xs text-muted-foreground">
                These fields appear in search engine results. Leave blank to use
